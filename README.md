...
**[math_magicians]** is a website for all fans of mathematics.
...
```sh
cd math_magicians
git clone https://github.com/erickma1/math_magicians.git
```
...
This project is [MIT](https://github.com/erickma1/math_magicians/blob/dev/LICENSE) licensed.
